...
const Home = () => {
  ...
  return (
    <div className="w-full h-[100dvh]">
      ...
      <NavbarTwo />
      <div className="w-full lg:px-[3%] sm:px-3 px-[5%] flex justify-center">
        <div className="w-full max-w-[1500px] flex flex-col">
          ...
          <div className="w-full h-fit flex items-center gap-3">
            <div className="bg-[#D9D9D9]/40 rounded-2xl w-full h-full p-5 flex flex-col">
              ...
              <div className="w-full bg-white py-[5%] px-2 rounded-2xl flex justify-center items-center gap-3">
            ...
            <div className="w-full h-full space-y-4 flex flex-col justify-between">
              ...
              <div className="w-full rounded-2xl h-full bg-[#FFB06A]/40 flex justify-between px-5 py-7">
                <div>
                  <h2 className="text-xl font-bold text-red-500">
                    Free shipping
                  </h2>
            ...
            <div className="bg-yellow-500 rounded-2xl w-full h-full"></div>
          </div>
        </div>
      </div>
    </div>

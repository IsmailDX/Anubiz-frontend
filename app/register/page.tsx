                ...
                >
                    ...
                    >
                        <Form className="flex flex-col items-center w-full mt-[30%] px-[5%] 2xl:px-[10%] space-y-[3%]">
                            ...
                            {error && (
                                <div className="w-full bg-red-200 border-2 border-red-300 rounded-lg flex justify-center items-center gap-2 px-2 z-10">
                            ...
                            {success && (
                                <div className="w-full bg-green-200 border-2 border-green-300 rounded-lg flex justify-center items-center gap-2 px-2 z-10">

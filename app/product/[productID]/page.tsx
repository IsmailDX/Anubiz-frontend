        ...
        <div className="w-full h-full flex justify-center  max-w-[1500px]">
          <div className="w-full h-full p-5 flex items-start select-none">
            <Swiper
              ...
              className="mySwiperProduct1 w-fit h-72"
            >
              {product
                ...
                .map((item, index) => (
                  <>
                    {item.image.map((imageUrl, imageIndex) => (
                      <SwiperSlide key={index} className="w-14 h-14 bg-white">
                        <Image
                          key={imageIndex}
                          src={imageUrl}
                          alt={item.name}
            ...
            <Swiper
              ...
              modules={[FreeMode, Thumbs]}
              className="mySwiperProduct2 w-[600px] h-[600px]"
            >
              {product
                .filter((item) => item._id === params.productID)
                .map((item, index) => (
          ...
          {product
            ...
            .map((item, index) => (
              <div className="h-fit flex flex-col max-w-[35%] p-5">
                <h1 className="2xl:text-3xl lg:text-2xl">{item.name}</h1>
